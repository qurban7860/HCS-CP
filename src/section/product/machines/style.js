...
export const StyledHeaderTableCell = styled(TableCell)(({ theme, mode, item }) => ({
  ...
  whiteSpace: 'nowrap',
  width: item.key === KEY.NAME ? '20%' : `calc(100% / ${HEADER.length})`
}))

export const StyledIconListItemText = styled(ListItemText)(({ theme, inActive }) => ({
...
export const StyledTableRow = styled(TableRow)(({ theme, mode, index }) =>
  index % 2
    ? {
