...
const SiteTab = ({ value, isBilling, isLoading, handleSiteWidgetDialog }) => {
 ...
 return (
  <Grid container p={2} alignItems={KEY.CENTER} justifyContent={KEY.CENTER} flexDirection={FLEX_DIR.ROW} gap={2}>
   ...
   <Grid item xs={12}>
    <GStyledSiteMapBox>{validCoordinates ? <GoogleMaps machineView latlongArr={latLong} mapHeight={MAP.MACHINE.HEIGHT} /> : <NothingProvided content={SNACK.NO_COORIDNATES} />}</GStyledSiteMapBox>
   </Grid>
  </Grid>
 )
}
