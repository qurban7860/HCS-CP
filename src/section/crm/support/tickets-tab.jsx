...
const TicketsTab = () => {
 ...
 const ticket = useTicketDefaultValues(customerTicket)
      ...
      <Grid item lg={12} sm={12} mb={2}>
       ...
       <Grid container p={1}>
        ...
        {filteredData?.length > 0 && !isLoading ? (
         defaultValues?.map((t, index) => <TicketCard key={index} selectedCardId={selectedCustomerTicketCard} value={t} handleCustomerTicketCard={handleCustomerTicketKey} t={t} />)
        ) : isLoading ? (
