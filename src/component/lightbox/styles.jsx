  ...
  const inputGlobalStyles = (
    <GlobalStyles
      styles={{
        ...
        '.yarl__button': { filter: 'unset' },
        '.yarl__thumbnails_thumbnail': { opacity: 0.48, '&.yarl__thumbnails_thumbnail_active': { opacity: 1 },
        },
        '.yarl__thumbnails_vignette': { '--yarl__thumbnails_vignette_size': 0 },
        '.yarl__video_container': { backgroundColor: theme.palette.common.black },
      }}
    />
  );
