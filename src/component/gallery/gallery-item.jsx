                ...
                >
                    ...
                    {toolbar &&
                        <ButtonGroup
                            ...
                            {(onDownloadFile || onDeleteFile) && <Button sx={{ width: onDeleteFile && !isArchived ? '33%' : '50%' }} disabled={!(fileType?.startsWith('image') || fileType?.startsWith('application/pdf'))} onClick={fileType?.startsWith('image') ? onOpenLightbox : onOpenFile}><Icon icon={ICON_NAME.PREVIEW} sx={{ width: 20, height: 20 }} /></Button>}
