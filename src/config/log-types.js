...
const _GEN5_LOG_TYPES = {
    ERP: {
        ...
        tableColumns: [
            ...
            { id: 'componentLength', label: 'P.Length', unit: 'm', fullLabel: 'Produced Length', alwaysShow: true, defaultShow: true, tooltip: true, numerical: true, convertToM: true },
            { id: 'waste', label: 'Waste', unit: 'm', alwaysShow: true, defaultShow: true, numerical: true, convertToM: true },
            { id: 'coilLength', label: 'Rem.Coil', unit: 'm', fullLabel: 'Remaining Coil Length', defaultShow: true, numerical: true, tooltip: true, convertToM: true },
            { id: 'flangeHeight', label: 'Flange', unit: 'mm', fullLabel: 'Flange Height', defaultShow: true, numerical: true, tooltip: true },
            { id: 'webWidth', label: 'Web', unit: 'mm', fullLabel: 'Web Width', defaultShow: true, numerical: true, tooltip: true },
            ...
            { id: 'coilThickness', label: 'C.T', unit: 'm', fullLabel: 'Coil Thickness', numerical: true, tooltip: true, convertToM: true },
            ...
            { id: 'coilWidth', label: 'C.W', unit: 'm', fullLabel: 'Coil Width', numerical: true, tooltip: true, convertToM: true },
