...
const ICON_WEB = {
  ...
  ARROW_RIGHT: _getWebIcon('arrow-right'),
  ...
  DOCUMENT: _getAnyWebIcon('solar:document-bold'),
  DOCUMENTS: _getAnyWebIcon('solar:documents-bold'),
  DOWNLOAD: _getWebIcon('download-outline'),
  DOWNLOADING: _getAnyWebIcon('ic:twotone-downloading'),
  DRAWING: _getAnyWebIcon('streamline:hand-held-tablet-drawing-solid'),
  ...
  LOG: _getAnyWebIcon('gridicons:pages'),
  LOGS: _getAnyWebIcon('iconoir:multiple-pages'),
