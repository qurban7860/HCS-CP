...
import { getCustomerMachines, getCustomerTickets, getCustomer, resetCustomer, resetCustomerMachines, resetCustomerTicketRecords } from 'store/slice'
    ...
    <Grid container>
      <Grid container spacing={3} mt={2}>
        <Grid item xs={12}>
          ...
          <DashboardWidget machines={customerMachines} supportTickets={customerTickets?.issues} />
        </Grid>
      </Grid>
    </Grid>
  )
