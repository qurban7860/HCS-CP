...
export const Authenticate = Loadable(
  lazy(() => import('../sections/auth/Authenticate'))
)
...
export const CustomerAdd = Loadable(
  lazy(() => import('../pages/customer/CustomerAdd'))
)
export const CustomerEdit = Loadable(
  lazy(() => import('../pages/customer/CustomerEdit'))
)
export const CustomerView = Loadable(
  lazy(() => import('../pages/customer/CustomerView'))
)

// SITE
export const SiteList = Loadable(
  lazy(() => import('../pages/customer/site/SiteList'))
)
export const SiteAdd = Loadable(
  lazy(() => import('../pages/customer/site/SiteAdd'))
)
export const SiteEdit = Loadable(
  lazy(() => import('../pages/customer/site/SiteEdit'))
)
export const SiteView = Loadable(
  lazy(() => import('../pages/customer/site/SiteView'))
)

// CONTACT
export const ContactList = Loadable(
  lazy(() => import('../pages/customer/contact/ContactList'))
)
export const ContactAdd = Loadable(
  lazy(() => import('../pages/customer/contact/ContactAdd'))
)
export const ContactEdit = Loadable(
  lazy(() => import('../pages/customer/contact/ContactEdit'))
)
export const ContactView = Loadable(
  lazy(() => import('../pages/customer/contact/ContactView'))
)

// NOTE
export const NoteList = Loadable(
  lazy(() => import('../pages/customer/note/NoteList'))
)
export const NoteAddForm = Loadable(
  lazy(() => import('../pages/customer/note/NoteAddForm'))
)
export const NoteEditForm = Loadable(
  lazy(() => import('../pages/customer/note/NoteEditForm'))
)
export const NoteViewForm = Loadable(
  lazy(() => import('../pages/customer/note/NoteViewForm'))
)
...
export const SecurityUserList = Loadable(
  lazy(() => import('../pages/user/SecurityUserList'))
)
export const SecurityUserAdd = Loadable(
  lazy(() => import('../pages/user/SecurityUserAdd'))
)
export const SecurityUserEdit = Loadable(
  lazy(() => import('../pages/user/SecurityUserEdit'))
)
export const SecurityUserViewForm = Loadable(
  lazy(() => import('../pages/user/SecurityUserView'))
)

// SECURITY USERS ROLES
export const RoleList = Loadable(
  lazy(() => import('../pages/user/role/RoleList'))
)
export const RoleAdd = Loadable(
  lazy(() => import('../pages/user/role/RoleAddForm'))
)
export const RoleEdit = Loadable(
  lazy(() => import('../pages/user/role/RoleEditForm'))
)
export const RoleView = Loadable(
  lazy(() => import('../pages/user/role/RoleView'))
)

//----------------------------------------------------------------

// Machine
export const MachineSetting = Loadable(
  lazy(() => import('../pages/machine/Machine'))
)
export const MachineAdd = Loadable(
  lazy(() => import('../pages/machine/MachineAddForm'))
)
export const MachineList = Loadable(
  lazy(() => import('../pages/machine/MachineList'))
)
export const MachineView = Loadable(
  lazy(() => import('../pages/machine/MachineView'))
)
export const MachineEdit = Loadable(
  lazy(() => import('../pages/machine/MachineEdit'))
)
export const MachineTransfer = Loadable(
  lazy(() => import('../pages/machine/MachineTransfer'))
)
...
export const SupplierList = Loadable(
  lazy(() => import('../pages/machine/Supplier/SupplierList'))
)
export const SupplierView = Loadable(
  lazy(() => import('../pages/machine/Supplier/SupplierView'))
)
export const SupplierViewForm = Loadable(
  lazy(() => import('../pages/machine/Supplier/SupplierViewForm'))
)
export const SupplierEdit = Loadable(
  lazy(() => import('../pages/machine/Supplier/SupplierEdit'))
)
export const SupplierEditForm = Loadable(
  lazy(() => import('../pages/machine/Supplier/SupplierEditForm'))
)
export const SForm = Loadable(
  lazy(() => import('../pages/machine/Supplier/SupplierEditForm'))
)
...
// Signin Logs
export const SignInLogList = Loadable(
  lazy(() => import('../pages/user/signInLog/SignInLogList'))
)
...
export const BlockedCustomerList = Loadable(
  lazy(() =>
    import('../pages/security/config/blockedCustomer/BlockedCustomerList')
  )
)
export const BlockedCustomerAddForm = Loadable(
  lazy(() =>
    import('../pages/security/config/blockedCustomer/BlockedCustomerAddForm')
  )
)
...
export const ServiceCategoryAddForm = Loadable(
  lazy(() =>
    import('../pages/machine/ServiceCategories/ServiceCategoryAddForm')
  )
)
...
export const ServiceCategoryViewForm = Loadable(
  lazy(() =>
    import('../pages/machine/ServiceCategories/ServiceCategoryViewForm')
  )
)
...
export const ServiceCategoryEditForm = Loadable(
  lazy(() =>
    import('../pages/machine/ServiceCategories/ServiceCategoryEditForm')
  )
)
...
// Machine Tools
export const ToolAddForm = Loadable(
  lazy(() => import('../pages/machine/Tool/ToolAddForm'))
)
export const ToolList = Loadable(
  lazy(() => import('../pages/machine/Tool/ToolList'))
)
export const ToolView = Loadable(
  lazy(() => import('../pages/machine/Tool/ToolView'))
)
export const ToolViewForm = Loadable(
  lazy(() => import('../pages/machine/Tool/ToolViewForm'))
)
export const ToolEdit = Loadable(
  lazy(() => import('../pages/machine/Tool/ToolEdit'))
)
export const ToolEditForm = Loadable(
  lazy(() => import('../pages/machine/Tool/ToolEditForm'))
)

// MachineTechParam
export const TechParamCategoryAddForm = Loadable(
  lazy(() =>
    import('../pages/machine/TechParamCategory/TechParamCategoryAddForm')
  )
)
...
export const TechParamCategoryViewForm = Loadable(
  lazy(() =>
    import('../pages/machine/TechParamCategory/TechParamCategoryViewForm')
  )
)
...
export const TechParamCategoryEditForm = Loadable(
  lazy(() =>
    import('../pages/machine/TechParamCategory/TechParamCategoryEditForm')
  )
)

// Machine Statuses
export const StatusAddForm = Loadable(
  lazy(() => import('../pages/machine/Status/StatusAddForm'))
)
export const StatusList = Loadable(
  lazy(() => import('../pages/machine/Status/StatusList'))
)
export const StatusViewForm = Loadable(
  lazy(() => import('../pages/machine/Status/StatusViewForm'))
)
export const StatusView = Loadable(
  lazy(() => import('../pages/machine/Status/StatusView'))
)
export const StatusEditForm = Loadable(
  lazy(() => import('../pages/machine/Status/StatusEditForm'))
)
export const StatusEdit = Loadable(
  lazy(() => import('../pages/machine/Status/StatusEdit'))
)

// Machine Model
export const ModelAddForm = Loadable(
  lazy(() => import('../pages/machine/Model/ModelAddForm'))
)
export const ModelList = Loadable(
  lazy(() => import('../pages/machine/Model/ModelList'))
)
export const ModelViewForm = Loadable(
  lazy(() => import('../pages/machine/Model/ModelViewForm'))
)
export const ModelView = Loadable(
  lazy(() => import('../pages/machine/Model/ModelView'))
)
export const ModelEditForm = Loadable(
  lazy(() => import('../pages/machine/Model/ModelEditForm'))
)
export const ModelEdit = Loadable(
  lazy(() => import('../pages/machine/Model/ModelEdit'))
)

// Machine Service Record Config
export const ServiceRecordConfigAddForm = Loadable(
  lazy(() =>
    import('../pages/machine/ServiceRecordConfig/ServiceRecordConfigAddForm')
  )
)
export const ServiceRecordConfigList = Loadable(
  lazy(() =>
    import('../pages/machine/ServiceRecordConfig/ServiceRecordConfigList')
  )
)
export const ServiceRecordConfigView = Loadable(
  lazy(() =>
    import('../pages/machine/ServiceRecordConfig/ServiceRecordConfigView')
  )
)
export const ServiceRecordConfigViewForm = Loadable(
  lazy(() =>
    import('../pages/machine/ServiceRecordConfig/ServiceRecordConfigViewForm')
  )
)
export const ServiceRecordConfigEdit = Loadable(
  lazy(() =>
    import('../pages/machine/ServiceRecordConfig/ServiceRecordConfigEdit')
  )
)
export const ServiceRecordConfigEditForm = Loadable(
  lazy(() =>
    import('../pages/machine/ServiceRecordConfig/ServiceRecordConfigEditForm')
  )
)
...
export const DocumentCategoryAddForm = Loadable(
  lazy(() =>
    import('../pages/document/documentCategory/DocumentCategoryAddForm')
  )
)
...
export const DocumentCategoryEditForm = Loadable(
  lazy(() =>
    import('../pages/document/documentCategory/DocumentCategoryEditForm')
  )
)
...
export const DepartmentAdd = Loadable(
  lazy(() => import('../pages/Department/DepartmentAddForm'))
)
export const DepartmentList = Loadable(
  lazy(() => import('../pages/Department/DepartmentList'))
)
export const DepartmentEdit = Loadable(
  lazy(() => import('../pages/Department/DepartmentEditForm'))
)
export const DepartmentView = Loadable(
  lazy(() => import('../pages/Department/DepartmentView'))
)
...
export const Emailviewform = Loadable(
  lazy(() => import('../pages/email/EmailViewform'))
)
...
export const UserInviteLanding = Loadable(
  lazy(() => import('../pages/UserInviteLanding'))
)
