...
export const PATH_MACHINE = {
    ...
    machines: {
        ...
        drawings: {
            list: machineId => conNex(ROOTS_PRODUCTS, SUB_MACHINES, machineId, 'drawings'),
            view: (machineId, id) => conNex(ROOTS_PRODUCTS, SUB_MACHINES, machineId, 'drawings', id, 'view'),
        },
        documents: {
            list: machineId => conNex(ROOTS_PRODUCTS, SUB_MACHINES, machineId, 'documents'),
            view: (machineId, id) => conNex(ROOTS_PRODUCTS, SUB_MACHINES, machineId, 'documents', id, 'view')
        },
        graph: {
